...
use crate::{
    identifier::{
        ...
        time::{DecisionTimespan, TransactionTimespan},
    },
            ...
            .and_then(|row| async move {
                ...
                Ok(Entity::new(
                    ...
                    EntityEditionId::new(
                        ...
                        EntityVersion::new(
                            DecisionTimespan::from_date_time(row.get(decision_time_index)),
                            TransactionTimespan::from_date_time(row.get(transaction_time_index)),
                        ),
                    ),
                    entity_type_uri,
